...
<html lang="es">
    ...
    <body>  
            <div class="accordion-item">
                <h3 class="accordion-header" id="headingDatos">
            ...
            <div class="accordion" id="reporteAccordion">
                ...
                ============================================================ --}}
                <div class="accordion-item">
                    <h3| class="accordion-header" id="headingResumen">
                ...
                @if(is_array($json) && ($json['tipo_sujeto'] ?? null) === 'persona')
                    ...
                    {{-- HALLAZGOS --}}
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingHallazgos">
                    ...
                    {{-- LISTAS RESTRICTIVAS --}}
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingListas">
                    ...
                    {{-- ANTECEDENTES --}}
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingAntecedentes">
                    ...
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingAntecedentesCompletos">
                    ...
                    {{-- RUNT --}}
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingRunt">
                    ...
                    {{-- PROFESIONALES --}}
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingProfesionales">
